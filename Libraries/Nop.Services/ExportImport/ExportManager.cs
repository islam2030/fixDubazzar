...
namespace Nop.Services.ExportImport
{
    ...
    public partial class ExportManager : IExportManager
    {
        ...
        // 11-7-2018 export arabic language with excel 
        ...
        public ExportManager(ICategoryService categoryService,
            ...
            // export arabic language in excel 11-7-2017
        ...
        public virtual byte[] ExportProductsToXlsx(IEnumerable<Product> products)
        {
            var properties = new[]
            {
                ...
                // read arabic property 11-7-2018
        ...
        public virtual byte[] ExportOrdersToXlsx(IList<Order> orders)
        {
            ...
            var properties = new[]
            {
                new PropertyByName<Order>("OrderId", p => p.Id,ignore),
                new PropertyByName<Order>("StoreId", p => p.StoreId,ignore),
                ...
                new PropertyByName<Order>("PaymentStatusId", p => p.PaymentStatusId,ignore),
                ...
                new PropertyByName<Order>("CurrencyRate", p => p.CurrencyRate,ignore),
                new PropertyByName<Order>("CustomerCurrencyCode", p => p.CustomerCurrencyCode,ignore),
                ...
                new PropertyByName<Order>("ShippingMethod", p => p.ShippingMethod,ignore),
                ...
                new PropertyByName<Order>("CreatedOnUtc", p => p.CreatedOnUtc.ToOADate(),ignore),
                new PropertyByName<Order>("BillingFirstName", p => p.BillingAddress?.FirstName ?? string.Empty,ignore),
                new PropertyByName<Order>("BillingLastName", p => p.BillingAddress?.LastName ?? string.Empty,ignore),
                new PropertyByName<Order>("BillingEmail", p => p.BillingAddress?.Email ?? string.Empty,ignore),
                new PropertyByName<Order>("BillingCompany", p => p.BillingAddress?.Company ?? string.Empty,ignore),
                new PropertyByName<Order>("BillingCountry", p => p.BillingAddress?.Country?.Name ?? string.Empty,ignore),
                new PropertyByName<Order>("BillingStateProvince", p => p.BillingAddress?.StateProvince?.Name ?? string.Empty,ignore),
                new PropertyByName<Order>("BillingCity", p => p.BillingAddress?.City ?? string.Empty,ignore),
                new PropertyByName<Order>("BillingAddress1", p => p.BillingAddress?.Address1 ?? string.Empty,ignore),
                new PropertyByName<Order>("BillingAddress2", p => p.BillingAddress?.Address2 ?? string.Empty,ignore),
                new PropertyByName<Order>("BillingZipPostalCode", p => p.BillingAddress?.ZipPostalCode ?? string.Empty,ignore),
                new PropertyByName<Order>("BillingPhoneNumber", p => p.BillingAddress?.PhoneNumber ?? string.Empty,ignore),
                new PropertyByName<Order>("BillingFaxNumber", p => p.BillingAddress?.FaxNumber ?? string.Empty,ignore),
                new PropertyByName<Order>("ShippingFirstName", p => p.ShippingAddress?.FirstName ?? string.Empty,ignore),
                new PropertyByName<Order>("ShippingLastName", p => p.ShippingAddress?.LastName ?? string.Empty,ignore),
                new PropertyByName<Order>("ShippingEmail", p => p.ShippingAddress?.Email ?? string.Empty,ignore),
                new PropertyByName<Order>("ShippingCompany", p => p.ShippingAddress?.Company ?? string.Empty,ignore),
                new PropertyByName<Order>("ShippingCountry", p => p.ShippingAddress?.Country?.Name ?? string.Empty,ignore),
                new PropertyByName<Order>("ShippingStateProvince", p => p.ShippingAddress?.StateProvince?.Name ?? string.Empty,ignore),
                new PropertyByName<Order>("ShippingCity", p => p.ShippingAddress?.City ?? string.Empty,ignore),
                new PropertyByName<Order>("ShippingAddress1", p => p.ShippingAddress?.Address1 ?? string.Empty,ignore),
                new PropertyByName<Order>("ShippingAddress2", p => p.ShippingAddress?.Address2 ?? string.Empty,ignore),
                new PropertyByName<Order>("ShippingZipPostalCode", p => p.ShippingAddress?.ZipPostalCode ?? string.Empty,ignore),
                new PropertyByName<Order>("ShippingPhoneNumber", p => p.ShippingAddress?.PhoneNumber ?? string.Empty,ignore),
                new PropertyByName<Order>("ShippingFaxNumber", p => p.ShippingAddress?.FaxNumber ?? string.Empty,ignore)
            };
