...
using OfficeOpenXml;
// import arabic language in excel 11-7-2017
...
namespace Nop.Services.ExportImport
{
    ...
    public partial class ImportManager : IImportManager
    {
        ...
        // import arabic language in excel 11-7-2017 
        Core.Domain.Localization.LocalizedProperty l;
        Core.Domain.Localization.LocalizedProperty l2;
        Core.Domain.Localization.LocalizedProperty l3;
        ...
        public ImportManager(IProductService productService,
            ...
            // import arabic in excel 11-7-2018
            ...
            )
        {
            ...
            //import arabic language 11-7-2018
        ...
        protected virtual void ImportProductAttribute(PropertyManager<ExportProductAttribute> productAttributeManager, Product lastLoadedProduct)
        {
            ...
            var productAttributeCombination = _productAttributeService.GetAllProductAttributeCombinations(lastLoadedProduct.Id);
            var combination = new ProductAttributeCombination
            {
                ProductId = lastLoadedProduct.Id,
                AttributesXml = "<Attributes><ProductAttribute ID=" + '\"' + productAttributeMapping.Id + '\"' + "><ProductAttributeValue><Value>" + pav.Id + "</Value></ProductAttributeValue></ProductAttribute></Attributes>",
                StockQuantity = quantity,
                AllowOutOfStockOrders = false,
                NotifyAdminForQuantityBelow = 1,
            };
            var match = false;
            var matchitem = new ProductAttributeCombination();
            foreach (var combin in productAttributeCombination)
            {
                if (combination.AttributesXml == combin.AttributesXml)
                {
                    match = true;
                    matchitem = combin;
                }
            ...
            {
                matchitem.StockQuantity = combination.StockQuantity;
                _productAttributeService.UpdateProductAttributeCombination(matchitem);
            }
            ...
            using (var xlPackage = new ExcelPackage(stream))
            {
                ...
                for (var iRow = 2; iRow < endRow; iRow++)
                {
                    ...
                    foreach (var property in manager.GetProperties)
                    {
                        switch (property.PropertyName)
                        {
                            ...
                            case "Height":
                                ...
                                //read arabic language 11-7-2018
                            case "ArName":
                                var arname = property.StringValue;
                                l = new Core.Domain.Localization.LocalizedProperty();

                                l.LanguageId = 2;
                                l.LocaleKey = "Name";
                                l.LocaleKeyGroup = "Product";
                                l.LocaleValue = arname;
                                break;

                            case "ArShortDescription":
                                var ArShortDescription = property.StringValue;
                                l2 = new Core.Domain.Localization.LocalizedProperty();

                                l2.LanguageId = 2;
                                l2.LocaleKey = "ShortDescription";
                                l2.LocaleKeyGroup = "Product";
                                l2.LocaleValue = ArShortDescription;
                                break;
                            case "ArFullDescription":
                                var ArFullDescription = property.StringValue;
                                l3 = new Core.Domain.Localization.LocalizedProperty();

                                l3.LanguageId = 2;
                                l3.LocaleKey = "FullDescription";
                                l3.LocaleKeyGroup = "Product";
                                l3.LocaleValue = ArFullDescription;
                                break;
                    ...
                    if (isNew)
                    {
                        ...
                        //read arabic language 11-7-2018
                        _localizedEntityService.SaveLocalizedValue(product, x => x.Name,l.LocaleValue,2);
                        _localizedEntityService.SaveLocalizedValue(product, x => x.ShortDescription,l2.LocaleValue,2);
                        _localizedEntityService.SaveLocalizedValue(product, x => x.FullDescription, l3.LocaleValue,2);
                    }
                    else
                    {
