...
namespace Nop.Services.Orders
{
    ...
    public partial class OrderProcessingService : IOrderProcessingService
    {
        ...
        protected virtual void MoveShoppingCartItemsToOrderItems(PlaceOrderContainer details, Order order)
        {
            foreach (var sc in details.Cart)
            {
                ...
                var orderItem = new OrderItem
                {
                    ...
                    //Finance 11/12/2018
                    ItemPrice = sc.Product.Price,
                    ItemCost = sc.Product.ProductCost
        ...
        /// <summary>
        /// Send a shipment product ready to shipped
        /// 11-6-2018 ereen 
        /// </summary>
        /// <param name="shipment">Shipment</param>
        /// <param name="notifyCustomer">True to notify customer</param>
        public virtual void ReadyToShipped(Shipment shipment, bool notifyCustomer)
        {
            if (shipment == null)
            ...
            if (shipment.ShippedDateUtc.HasValue)
                throw new Exception("This shipment is ready to shipped");

            shipment.ReadyShippedDateUtc = DateTime.UtcNow;
            ...
            if (order.HasItemsToAddToShipment() || order.HasItemsreadyToShip())
                order.ShippingStatusId = (int)ShippingStatus.ReadyToShipped;
            //else
