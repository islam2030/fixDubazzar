...
namespace Nop.Web.Areas.Admin.Models.Vendors
{
    ...
    public partial class VendorModel : BaseNopEntityModel, ILocalizedModel<VendorLocalizedModel>
    {
        ...
        //Finance 11/8/2018
        [NopResourceDisplayName("Pick Fee")]
        public decimal PickFee { get; set; }
        ...
        [NopResourceDisplayName("Admin.Vendors.Fields.IBAN")]
        public string IBAN { get; set; }
        [NopResourceDisplayName("Admin.Vendors.Fields.SwftCode")]

        public string SwftCode { get; set; }
        [NopResourceDisplayName("Admin.Vendors.Fields.Currancy")]
