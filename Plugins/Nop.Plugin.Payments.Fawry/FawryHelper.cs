...
namespace Nop.Plugin.Payments.Fawry
{
    ...
    public class FawryHelper
    {
        ...
        /// <summary>
        /// Get the generic attribute name that is used to store an order total that actually sent to Fawry (used to PDT order total validation)
        /// </summary>
        ...
        /// </summary>
        /// <param name="paymentStatus">Fawry payment status</param>
        /// <param name="pendingReason">Fawry pending reason</param>
