...
namespace Nop.Plugin.Shipping.FixedOrByWeight.Models
{
    public class ShippingByWeightModel : BaseNopEntityModel
    {
        public ShippingByWeightModel()
        {
            ...
            AvailableCategories = new List<SelectListItem>();//amal 25/10/2018
        }
        ...
        //amal 25/10/2018
        [NopResourceDisplayName("Plugins.Shipping.FixedOrByWeight.Fields.Category")]
        ...
        public IList<SelectListItem> AvailableCategories { get; set; }//amal 25/10/2018
    }
}