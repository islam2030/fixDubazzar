...
using Nop.Services.Catalog;//amal 25/10/2018
...
namespace Nop.Plugin.Shipping.FixedOrByWeight.Controllers
{
    ...
    public class FixedOrByWeightController : BasePluginController
    {
        ...
        private readonly ICategoryService _categoryService;//amal 25/10/2018
        ...
        public IActionResult AddRateByWeighPopup(ShippingByWeightModel model)
        {
            ...
            _shippingByWeightService.InsertShippingByWeightRecord(new ShippingByWeightRecord
            {
                ...
                CategoryId = model.CategoryId,//amal 25/10/2018
        ...
        public IActionResult EditRateByWeighPopup(int id)
        {
            ...
            var model = new ShippingByWeightModel
            {
                ...
                CategoryId = sbw.CategoryId,//amal 25/10/2018
            ...
            var selectedCategory = _categoryService.GetCategoryById(sbw.CategoryId);//amal 25/10/2018
            ...
            var categories = _categoryService.GetAllCategories(showHidden: true);
            foreach (var c in categories)
                model.AvailableCategories.Add(new SelectListItem { Text = c.Name, Value = c.Id.ToString(), Selected = (selectedCategory != null && c.Id == selectedCategory.Id) });
        ...
        public IActionResult EditRateByWeighPopup(ShippingByWeightModel model)
        {
            ...
            sbw.CategoryId = model.CategoryId;//amal 25/10/2018
